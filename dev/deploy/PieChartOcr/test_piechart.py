...
class TEST:
    def __init__(self, db_pie, nnet_pie):
        self.db_pie = db_pie
...
cache_path = os.path.join(osp.dirname(osp.abspath(__file__)),"data/piedata/cache")
db_pie, nnet_pie = load_net(50000, "CornerNetPurePie", data_path, cache_path, 0)

dl_model = TEST(db_pie, nnet_pie)

path = "/opt/ml/PieChartOcr/data/piedata/pie/images/val2019/fa2ea7d00fb6500b77b9a7b9e349d3b2_d3d3LmNhbm9la2F5YWstbGVtYW5zLm5ldAkyMTcuMTYuMTAuMw==.xls-1-0.png"
# path = "/opt/ml/PieChartOcr/data/piedata/pie/images/val2019/fa282ce5ed55721823a18eb8c99432de_d3d3LmluZWdpLmdvYi5teAkyMDAuMjMuOC41.xls-4-0.png"

deg_li, points_li = dl_model.test(path)
img = Image.open(path)
