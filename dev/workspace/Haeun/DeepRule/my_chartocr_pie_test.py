...
def parse_args():
    ...
    parser.add_argument("--image_path", dest="image_path", help="test images", default="/opt/ml/DeepRule/data/piedata/pie/images/test2019", type=str)
    parser.add_argument("--save_path", dest="save_path", help="where to save results", default="./val_save.json", type=str)
    parser.add_argument("--type", dest="type", help="type of images", default="Pie", type=str)
    parser.add_argument("--data_dir", dest="data_dir", default="/opt/ml/DeepRule/data/piedata/", type=str)
    parser.add_argument('--cache_path', dest="cache_path", type=str, default="/opt/ml/DeepRule/data/piedata/cache/")
