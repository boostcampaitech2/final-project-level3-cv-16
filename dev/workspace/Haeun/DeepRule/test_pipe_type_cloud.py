...
def parse_args():
    ...
    parser.add_argument("--image_path", dest="image_path", help="test images", default="/opt/ml/DeepRule/data/bardata/bar/images/test2019", type=str)
    ...
    parser.add_argument("--data_dir", dest="data_dir", default="./data/bardata_1031", type=str)
    parser.add_argument('--cache_path', dest="cache_path", type=str, default="cache_path")
